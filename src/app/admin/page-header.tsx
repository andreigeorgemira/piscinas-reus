 ...
 * actions on the right. One component rather than a copy per screen, because
 * the thing that makes a dashboard feel like one tool is that this strip is
 * the same height and the same weight everywhere.
 */
